...
# NOTE: there is currently a bug in ssh-keygen that prevents obtaining
# intermediate certificates from a FIDO attestation statement.
# Consequently, attestation certificate validation only works for
# security keys with attestation certificates that are direcly issued
# by a root certificate registered in MDS.
...
parser.add_argument('-k', '--key', dest='key_file', default = 'id_ecdsa_sk.pub', help='specify SSH pubkey file to validate attestation for')
